...
| **14:30 - 17:30** | **DL (the assignment of week 3 in the first class)** | **DL (the assignment of week 2 in the first class)** | <font color=red > DS (the upper half content of module 5 and related problems) | <font color=red > DL (the assignmentof week 4 in the first class) | <font color=red > DS (the all videos and problems of the module 5) | <font color=red > DS (the all videos and problems of the module 6) | do something I like |
